...
const style = {
    ...
    tweetButton: `bg-[#faebd7] hover:bg-[#f5f5dc] flex items-center justify-center font-bold rounded h-[40px] mt-[10px] cursor-pointer text-black `,
    navContainer: `flex-1 font- italic`,
    profileButton: `flex items-center mb-6 cursor-pointer hover:bg-[#333c45] rounded-[100px] p-2`,
    profileLeft: `flex item-center justify-center mr-6 `,
    profileImage: `height-10 w-10 rounded-full`,
