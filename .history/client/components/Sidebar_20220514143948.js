...
const style = {
    ...
    tweetButton: `bg-[#faebd7] hover:bg-[#f5f5dc] flex items-center justify-center font-family: Arial, Helvetica, sans-serif rounded h-[40px] mt-[20px] cursor-pointer text-black `,
    navContainer: `flex-1`,
