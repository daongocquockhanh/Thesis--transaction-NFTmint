...
const style = {
    wrapper: `flex-[1] p-4`,
    searchBar: `flex items-center bg-[#282828] p-2 rounded-3xl`,
    searchIcon: `text-[#FFFFFF] mr-2`,
    inputBox: `bg-transparent outline-none`,
    section: `bg-[#282828] my-6 rounded-xl overflow-hidden`,
    title: `p-2 font-bold text-white`,
